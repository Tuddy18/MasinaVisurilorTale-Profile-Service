defmodule Profiles.Auth do
    ...
    alias Profiles.Helpers.MapHelper
    
    @app_secret_key Application.get_env(:profiles, :app_secret_key)
    @jwt_validity Application.get_env(:profiles, :jwt_validity)
